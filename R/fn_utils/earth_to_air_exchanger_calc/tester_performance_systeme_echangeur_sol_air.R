...
, temperature_sol_C = 14
 ...
 temp_annuelle <- temperatures_annuelles(years_of_interest = years_of_interest,
                                         country = country,city_to_srch_for = city_to_srch_for )
  
 cat("\n 🌀 TESTER LA PERFORMANCE DU SYSTEME")
 
tests_temperature_au_quotidien <-  calc_temp_for_pipe_earth_to_air_exchanger(temperature_sol_C = temperature_sol_C
